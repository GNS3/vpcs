REM
REM  PC: 192.168 , 2001:ip4(3)::ip4(4)
REM  Rt: 172.16, 2002:ip4(2:3)::ip4(4)
REM         1.1                    172.16                   8.1   8.2
REM  PC1 - f1/0 -*        1.1  1.2         2.2  2.1     *- f1/0 - PC8 
REM  vlan10      +-- R1 - f0/0:f0/0 - R0 - f0/1:f0/0 - R2
REM              |  1.254                               *- f1/1 - PC9 
REM  PC2 - f1/1 -*                                          9.1   9.2
REM  vlan10 1.2  |      
REM              |
REM  PC3 - f1/2 -*
REM  vlan11 2.1  |
...
mkdir r1
cd r1
start ..\dynamips -i R1 -T 2001 -P 3600 -t 3660 -X -r 160 -c 0x2102 --sparse-mem --idle-pc=0x607789b8 ^
 -p 0:NM-1FE-TX -p 1:NM-16ESW ..\c3660-jk9o3s-mz.124-15.T5.bin.unzip ^
...
mkdir r2
cd r2
start ..\dynamips -i R2 -T 2002 -P 3600 -t 3660 -X -r 128 -c 0x2102 --sparse-mem --idle-pc=0x607789b8 ^
 -p 1:NM-4E ..\c3660-jk9o3s-mz.124-15.T5.bin.unzip  ^
...
start ..\dynamips -i R0  -T 2000 -P 3600 -t 3660 -X -r 128 -c 0x2102 --sparse-mem --idle-pc=0x607789b8 ^
 ..\c3660-jk9o3s-mz.124-15.T5.bin.unzip ^
